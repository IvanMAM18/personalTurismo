...
const EditCategoriaExperiencia = () => {
    ...
    function handleSubmit(e) {
        e.preventDefault();
        put(route("categorias-experiencia.update", categoria.data.id));
    }

    function destroy() {
        if (confirm("Estas seguro que deseas eliminar este registro?")) {
            router.delete(route("categorias-experiencia.destroy", categoria.data.id));
        }
    }

    function restore() {
        if (confirm("Estas seguro que deseas restaurar este registro ?")) {
            router.put(route("categorias-experiencia.restore", categoria.data.id));
        }
    }
    ...
    return (
        <div className="max-w-xl">
            ...
            <h1 className="mb-8 text-3xl font-bold">
                <Link
                    href={route("categorias-experiencia")}
...
EditCategoriaExperiencia.layout = (page) => <Layout children={page} />;

export default EditCategoriaExperiencia;
