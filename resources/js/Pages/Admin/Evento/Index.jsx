...
const IndexEventos = ({ eventos }) => {
    ...
    return (
        <div>
            <h1 className="mb-8 text-3xl font-bold">Evento</h1>
            <div className="flex items-center justify-between mb-6">
                ...
                >
                    <SecondaryButton>
                        <span>Nuevo</span>
                        <span className="hidden md:inline ml-1">Evento</span>
                    </SecondaryButton>
                </Link>
            </div>
...
IndexEventos.layout = (page) => <Layout title="Eventos" children={page} />;
