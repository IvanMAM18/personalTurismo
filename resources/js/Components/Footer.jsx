...
export default function Fotter(props) {
    ...
    return (
        <>
            <div className="flex mx-auto justify-center items-center bg-[#FFCB98] md:h-[15vw] mt-10 opacity-80">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-24 ">
                        <div className="flex justify-center items-center">
                            ...
                            <div className="text-gray-800 ">
                                <div className="text-[1.2vw] font-bold leading-4 border-l-2 border-l-[#9B234C] pl-3 ">
                                    CONTÁCTANOS
                                </div>
                                ...
                                <ul className="text-gray-950">
                                    <li className="my-2 font-bold flex gap-5">
                                        <a
                        ...
                        <div className=" text-[1vw] text-gray-800">
                            <ul>
            ...
            <div className="flex mx-auto justify-center items-center bg-gray-950 py-3 opacity-80">
